  ...
  return (
    <div className="space-y-10 animate-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-3xl font-black tracking-tight text-slate-900 mb-2 uppercase">Expense Tracker</h2>
          <p className="text-slate-500 font-black uppercase tracking-[0.2em] text-[10px]">Categorized expenditure & reimbursement logs</p>
        </div>
        <Link 
          href="/expenses/new"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="glass-card p-8 border-l-4 border-slate-900">
          <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] mb-2">Total Ledger</p>
          <h3 className="text-3xl font-black text-slate-900 tracking-tight">{formatCurrency(monthlyTotal)}</h3>
        </div>
        <div className="glass-card p-8 border-l-4 border-emerald-500">
          ...
          <h3 className="text-3xl font-black text-slate-900 tracking-tight">{formatCurrency(personalSpending)}</h3>
        </div>
        <div className="glass-card p-8 border-l-4 border-amber-500">
          <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] mb-2">Pending Requests</p>
          <h3 className="text-3xl font-black text-slate-900 tracking-tight">{pendingRequests} Pending</h3>
        </div>
      </div>
      ...
      <div className="glass-card overflow-hidden bg-white">
        <div className="p-8 border-b border-slate-100 flex flex-wrap gap-6 items-center justify-between">
          <div className="relative w-96">
            ...
            <input 
              type="text" 
              placeholder="Filter expenses by description or founder..." 
